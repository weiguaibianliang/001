...
@Table(name = "chest_pouch_sew")
@ApiModel(description = "衬衫胸袋工艺表")
public class ChestPouchSewModel extends IdModel {

    private static final long serialVersionUID = 5315888520664281416L;
