...
@Table(name = "front_piece_sew")
@ApiModel(description = "衬衫前片工艺表")
public class FrontPieceSewModel extends IdModel {

    private static final long serialVersionUID = -5934713071434333608L;
