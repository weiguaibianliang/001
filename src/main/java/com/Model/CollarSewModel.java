...
@Table(name = "collar_sew")
@ApiModel(description = "衬衫领子工艺表")
public class CollarSewModel extends IdModel {

    private static final long serialVersionUID = 1542566819128547719L;
