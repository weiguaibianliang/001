...
@Table(name = "sleeve_cuff_sew")
@ApiModel(description = "衬衫袖克夫工艺表")
public class SleeveCuffSewModel extends IdModel {

    private static final long serialVersionUID = 2183619216413108334L;
