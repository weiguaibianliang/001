...
@Table(name = "over_shoulder_sew")
@ApiModel(description = "衬衫过肩工艺表")
public class OverShoulderSewModel extends IdModel {

    private static final long serialVersionUID = -491514249758865049L;
    /**
     * 主表id
     */
    private Long mainId;
