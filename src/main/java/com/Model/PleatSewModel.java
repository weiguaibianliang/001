...
@Table(name = "pleat_sew")
@ApiModel(description = "衬衫褶裥工艺表")
public class PleatSewModel extends IdModel {


    private static final long serialVersionUID = 4854793564719233984L;
    /**
     * 主表id
     */
    private Long mainId;
