...
@Table(name = "province_sew")
@ApiModel(description = "衬衫省道工艺表")
public class ProvinceSewModel extends IdModel {

    private static final long serialVersionUID = 2929800665727766466L;
