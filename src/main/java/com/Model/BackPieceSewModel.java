...
@Table(name = "back_piece_sew")
@ApiModel(description = "衬衫后片工艺表")
public class BackPieceSewModel extends IdModel {

    private static final long serialVersionUID = 574619189461778271L;
